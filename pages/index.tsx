      ...
      <section className="text-center m-5">
        ...
        <div className="m-24 items-center flex flex-wrap justify-center">
          ...
          <Offer
            ...
            desc="Fully custom websites using the NextJS framework."
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
      ...
      <section className="m-5">
        <div className="m-24">
          ...
          <div className="flex text-center justify-center m-24">
            <div className="m-5">
              <InlineWidget
                styles={{ width: "500px", height: "650px" }}
            ...
            <div className="m-5 hidden xl:block">
              ...
              <p className="max-w-xl mt-8 mb-8 text-lg font-medium">
                ...
                form with inputs you must enter. Enter all the details asked so
                we can know more about what you guys do.
              </p>
              <hr />
              <p className="font-bold text-lg mt-8">
                Please only set a meeting if you are serious about working with
                us.
              </p>
            </div>
          </div>
